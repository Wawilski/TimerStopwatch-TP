...
class TestTimerLabels extends TestGUIAbstract {
  ...
  @Test
  @DisplayName("UI: Verify button label consistency across all Timer states")
  ...
  @Test
  @DisplayName("UI: Verify default labels and status text for Idle Timer")
  ...
  @Test
  @DisplayName("UI: Verify button labels update when entering SetTimer mode")
  ...
  @Test
  @DisplayName("UI: Verify button labels when switching to Stopwatch (Reset state)")
