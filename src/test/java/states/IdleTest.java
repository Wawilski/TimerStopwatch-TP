...
class IdleTest {
  ...
  // code
  @Test
  @DisplayName("Verify IdleTimer follows the Singleton pattern for state consistency")
  ...
  @Test
  @DisplayName("Ensure 'up' event stays in Idle if the memory timer is zero")
  ...
  @Test
  @DisplayName("Verify that 'up' triggers a transition only when memory timer is non-zero")
  ...
  @Test
  @DisplayName("Ensure 'right' event correctly transitions from Idle to SetTimer")
  void testRight() {
