...
class StopwatchTests {
  ...
  @DisplayName("Verify that the Stopwatch starts in the Reset state with zeroed values")
  ...
  @org.junit.jupiter.api.Test
  @DisplayName("Ensure the default sub-state of AbstractStopwatch is ResetStopwatch")
  ...
  @Test
  @DisplayName("Verify that the Stopwatch correctly restores its previous state when returning from Timer mode")
